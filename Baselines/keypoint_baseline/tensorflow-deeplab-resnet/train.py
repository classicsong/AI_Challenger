...
def get_arguments():
    ...
    parser.add_argument("--work_dir", type=str, default="/data", help="UAI work dir")
    parser.add_argument("--data_dir", type=str, default="/data/data", help="UAI data dir")
    parser.add_argument("--output_dir", type=str, default="/data/output", help="UAI output dir")
    parser.add_argument("--log_dir", type=str, default="/data/output", help="UAI log dir")
    parser.add_argument("--num_gpus", type=int, default=1, help="gpu cnt")
